...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, default='cvd_2014', help='bvi_cc, cvqad, konvid_1k, youtube_ugc, live_vqc, cvd_2014, live_qualcomm, lsvq_train, cross_dataset')
    ...
    parser.add_argument('--epochs', type=int, default=120, help='Epochs for training') # 120(small), 20(big)
