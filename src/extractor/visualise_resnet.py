...
def process_video_frame(video_name, image_path, all_layers, qp):
    ...
    for layer_name in all_layers:
        # logger_setup.logger.debug(f'layer_{layer_name}, {frame_number}, qp_{qp}')
        ...
        activations_dict[layer_name] = activation_array
...
if __name__ == '__main__':
    ...
    for i in range(len(ugcdata)):
        ...
        for image_path in image_paths:
            print(f"{image_path}")
            process_video_frame(video_name, image_path, all_layers, qp)
